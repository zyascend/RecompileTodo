...
import com.zyascend.RecompileToDo.presenter.statisticstasks.StatisticsPresenterAchiever;
import com.zyascend.RecompileToDo.utils.ActivityUtils;
import com.zyascend.RecompileToDo.view.tasks.TasksActivity;
...
public class StatisticsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (statisticsFragment == null) {
            statisticsFragment = StatisticsFragment.getInstence();
        ...
        new StatisticsPresenterAchiever(mRepository,statisticsFragment);
    }
